...
export const siteMetadata: Record<string, Metadata> = {
  ...
  advertisers: {
    ...
    description:
      '高校生に直接リーチできる教室設置型デジタルサイネージ広告。3クラス実質3ヶ月（2026年6〜9月、夏季休業除く）の配信。ターゲット精度100%・カメラ不使用・全広告事前審査。料金はお問い合わせください。',
    openGraph: {
      title: '広告出稿のご案内 - キミテラス 工業高校の教室に届くデジタルサイネージ広告',
      description: '高校生に直接リーチできる教室設置型デジタルサイネージ広告。3クラス実質3ヶ月（2026年6〜9月、夏季休業除く）の配信。',
    },
  },
  schools: {
