...
export const siteMetadata: Record<string, Metadata> = {
  ...
  advertisers: {
    title: '広告出稿のご案内 - キミテラス 特別価格 3クラス3ヶ月（6〜8月）5万円',
    description:
      '高校生に直接リーチできる教室設置型デジタルサイネージ広告。実証実験特別価格で3クラス3ヶ月（6〜8月）5万円/社。20社限定。ターゲット精度100%の広告をお試しください。',
    openGraph: {
      title: '広告出稿のご案内 - キミテラス 特別価格 3クラス3ヶ月（6〜8月）5万円',
      description: '高校生に直接リーチできる教室設置型デジタルサイネージ広告。3クラス3ヶ月（6〜8月）5万円/社・20社限定。',
    },
  },
  schools: {
