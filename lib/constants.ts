...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  // ===== 広告主企業向け（PoC FAQポスターと同期）=====
  {
    ...
    answer: '本PoCは効果保証はありません。ただし認知率変化・QRスキャン数・人感検知回数（時間帯別）の3指標は必ず数字で出ます。「効かなかった」結果も含めてファクトをご提供します。',
  },
  {
    category: '効果・成果について',
    target: 'biz',
  ...
  },
  {
    ...
    target: 'biz',
    question: '動画広告は使えますか？',
    answer: '画像のみ・縦長（9:16）・1枠あたり30秒程度の表示でお願いしています。教室での視認性・配信の安定性・1ループ5分の枠設計を維持するため、本格運用フェーズでも動画は対応せず、画像運用を継続する方針です。',
  },
  {
    category: '申込・運用について',
    target: 'biz',
  ...
  },
  {
    ...
    answer: '授業中も含め平日朝〜夕方に常時配信します。複数社のローテーション配信で枠ごとに前後しますが、1社あたり1日合計でおよそ30分の露出を想定しています。',
  },
  {
    category: '申込・運用について',
    target: 'biz',
  ...
  },
  {
    ...
    answer: 'PoC結果を踏まえ、2026年度内に岐阜県内2〜3校への拡大を計画。PoC参加企業様には複数校展開時の優先枠をご案内します。',
  },
  {
    category: 'PoC後・継続について',
    target: 'biz',
    question: '本格運用への移行はどう進みますか？',
    answer: 'PoC終了から1週間以内に継続提案をお持ちします。継続される場合は希望プラン（スタンダード／プレミアム／エンタープライズ）をお選びいただき、9月以降の本格運用へシームレスに移行します。',
  },
  {
    category: 'PoC後・継続について',
    target: 'biz',
    question: 'PoC期間中に枠の追加・拡張は可能ですか？',
    answer: 'PoC期間中の枠追加（2社目以降のお申込み）は空きがある限り可能です。配信本数の増加やクリエイティブ複数バージョン運用は本格運用フェーズで対応します。',
  },
