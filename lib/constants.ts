...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer: 'Indeed等の待ち型媒体と異なり、教室の毎日に届く能動配信。合説と異なり継続的な接触。紙媒体と異なりQRスキャン数で行動変化を可視化できる点が違いです。',
  },
  {
...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    conditions: ['料金は掲載内容・期間に応じて個別見積り'],
    recommended: true,
    ctaText: '空き枠を見て申し込む →',
