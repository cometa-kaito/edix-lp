...
const SCHOOL_PROBLEMS = [
  { title: '先生の多忙化', desc: '連絡事項の伝達や資料作成に追われ、授業準備の時間が圧迫。プリント印刷・仕分け・配布に毎日数十分を消費' },
  { title: '通知を見ない生徒', desc: 'Google ClassroomやClassiで連絡しても、アプリを開かない生徒には届かない。「言った・言わない」のトラブルが頻発' },
  { title: '連絡の即時性不足', desc: '緊急連絡や時間割変更がリアルタイムで全員に届く手段がない。掲示板の貼り替えにも手間がかかる' },
];

const BIZ_PROBLEMS = [
  { title: '若者へのアプローチ手段不足', desc: 'SNS広告ではリーチしきれない高校生世代への手段が限られている' },
  { title: 'ターゲット精度の低さ', desc: '広告が届いてほしいターゲットに確実に届かない' },
  { title: '採用コスト高騰', desc: '求人媒体の費用が年々増加し、費用対効果が低下' },
];
        ...
        <div className={styles.grid}>
          ...
          <FadeIn className={styles.center}>
            ...
            <div className={styles.solution}>
              校内常設メディア<br /><strong>「キミテラス」</strong><br />で両方を解決
            </div>
            <div className={styles.arrow}>→</div>
          </FadeIn>
