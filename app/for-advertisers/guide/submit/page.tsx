      ...
      <div className={styles.card}>
        ...
        <table className={styles.table}>
          <tbody>
            ...
            <tr><th>表示時間</th><td>30秒程度（目安。枠のローテーションにより前後します）</td></tr>
        ...
        <div className={styles.note}>
          動画素材はPoC・本格運用フェーズともに <strong>受付対象外</strong> です。教室での視認性・配信安定性・1ループ5分の枠設計を維持するため、当面のあいだ <strong>画像のみ（JPEG／PNG）</strong> の運用を継続いたします。動画形式での訴求をご希望の場合は、静止画（縦長 9:16・30秒程度の表示）への変換をお願いいたします。必要に応じて連携先の岐阜文芸社さんへの取次が可能です。
        </div>
