      ...
      <div className="container">
        <article className={styles.wrapper}>
          ...
          <dl className={styles.dlGrid}>
            ...
            <dt>販売価格</dt>
            <dd>
              50,000円（税抜）／社／3クラス・実質3ヶ月
              <div className={styles.note}>
                実証実験特別価格（2026年6〜9月、夏季休業除く）。本格運用フェーズの価格は別途ご案内いたします。
              </div>
            </dd>
            ...
            <dt>支払時期・方法</dt>
            <dd>
              契約締結後に当社より請求書を発行いたします。稼働開始月（2026年6月）末日までに、指定銀行口座への振込にてお支払いください。
            </dd>

            <dt>役務の提供時期</dt>
            <dd>契約・素材入稿・審査完了後、2026年6月の指定日より配信を開始いたします。</dd>
            ...
            <dt>稼働保証</dt>
            <dd>
              稼働率を週次でモニタリングし月次レポートで開示いたします。稼働率90%を下回った場合は、該当日数分を割引いたします。
            </dd>
          </dl>
